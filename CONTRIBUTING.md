...
- Self-promotion of paid / closed-source tools without an open-source alternative being mentioned alongside.
- Tools that haven't been touched in 3+ years unless they're still genuinely the standard (PESQ, WebRTC VAD, etc.).
- LLM-generated descriptions that don't reflect how the tool actually behaves. We'd rather have one honest sentence than a polished-sounding paragraph that misleads people.
- Walls of text. Every entry is a one-liner. If a tool needs more context, link to a deeper doc instead.
...
4. If you're adding a new section, explain why it doesn't fit an existing one.

## Licensing of contributions

By submitting a PR, you agree your contribution is released under the repo's MIT license (see [`LICENSE`](./LICENSE)).
